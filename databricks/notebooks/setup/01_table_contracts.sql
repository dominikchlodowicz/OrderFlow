...
CREATE TABLE IF NOT EXISTS orderflow_dev.silver.orders (
  order_id STRING NOT NULL,
  customer_id STRING,
  order_status STRING NOT NULL COMMENT 'One of: created, paid, shipped, delivered, cancelled, partially_refunded, refunded',
...
CREATE TABLE IF NOT EXISTS orderflow_dev.silver.payments (
  ...
  payment_status STRING NOT NULL COMMENT 'One of: captured, authorized, failed, refunded',
...
CREATE TABLE IF NOT EXISTS orderflow_dev.silver.web_events (
  ...
  event_type STRING NOT NULL COMMENT 'One of: page_view, product_view, add_to_cart, checkout_started, purchase_completed',
...
CREATE TABLE IF NOT EXISTS orderflow_dev.silver.shipments (
  ...
  shipment_status STRING NOT NULL COMMENT 'One of: lost, shipped, delivered, returned',
...
CREATE TABLE IF NOT EXISTS orderflow_dev.silver.refunds (
  ...
  refund_reason STRING,
  refund_status STRING NOT NULL COMMENT 'One of: processed, rejected',
...
CREATE TABLE IF NOT EXISTS orderflow_dev.gold.dim_campaigns (
  ...
  campaign_id STRING NOT NULL COMMENT 'Source campaign identifier',
  campaign_name STRING NOT NULL,
  source_channel STRING COMMENT 'One of: email, paid_search, social for regular campaigns',
  start_date DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS orderflow_dev.gold.fct_payments (
  ...
  payment_status STRING NOT NULL COMMENT 'One of: authorized, captured, failed, refunded',

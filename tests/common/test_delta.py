...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ORDER_ITEMS_SILVER_TABLE, "orderflow_dev.silver.order_items"),
        (ORDERS_SILVER_TABLE, "orderflow_dev.silver.orders"),
        (PAYMENTS_SILVER_TABLE, "orderflow_dev.silver.payments"),
        (WEB_EVENTS_SILVER_TABLE, "orderflow_dev.silver.web_events"),
        (SHIPMENTS_SILVER_TABLE, "orderflow_dev.silver.shipments"),
        (REFUNDS_SILVER_TABLE, "orderflow_dev.silver.refunds"),
        (
            MARKETING_CAMPAIGNS_SILVER_TABLE,
            "orderflow_dev.silver.marketing_campaigns",
        ),
        (PRODUCTS_SILVER_TABLE, "orderflow_dev.silver.products"),
        (EXCHANGE_RATES_SILVER_TABLE, "orderflow_dev.silver.exchange_rates"),
        (CALENDAR_GOLD_TABLE, "orderflow_dev.gold.dim_calendar"),
        (CUSTOMERS_GOLD_TABLE, "orderflow_dev.gold.dim_customers"),
        (PRODUCTS_GOLD_TABLE, "orderflow_dev.gold.dim_products"),
        (CAMPAIGNS_GOLD_TABLE, "orderflow_dev.gold.dim_campaigns"),
        (CURRENCY_GOLD_TABLE, "orderflow_dev.gold.dim_currency"),
        (ORDERS_GOLD_TABLE, "orderflow_dev.gold.fct_orders"),
        (ORDER_ITEMS_GOLD_TABLE, "orderflow_dev.gold.fct_order_items"),
        (PAYMENTS_GOLD_TABLE, "orderflow_dev.gold.fct_payments"),
        (REFUNDS_GOLD_TABLE, "orderflow_dev.gold.fct_refunds"),
        (SHIPMENTS_GOLD_TABLE, "orderflow_dev.gold.fct_shipments"),
        (WEB_EVENTS_GOLD_TABLE, "orderflow_dev.gold.fct_web_events"),
        (EXCHANGE_RATES_GOLD_TABLE, "orderflow_dev.gold.fct_exchange_rates"),
    ],
)

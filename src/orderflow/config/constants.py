...
CALENDAR_BRONZE_TABLE = f"{ORDERFLOW_CATALOG}.bronze.bronze_calendar"
CUSTOMERS_BRONZE_TABLE = f"{ORDERFLOW_CATALOG}.bronze.bronze_customers"

CALENDAR_SILVER_TABLE = f"{ORDERFLOW_CATALOG}.silver.silver_calendar"
CUSTOMERS_SILVER_TABLE = f"{ORDERFLOW_CATALOG}.silver.silver_customers"
